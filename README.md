...
## Changes done
 ...
 1 . Changed /block/:hash to /block_hash/:hash as by default the request to /block/:hash was going to /block/:height

 2. Instead of using postman created testBlockChainController for the two post calls requestValidation and submitStar.

 ### Usage

 1. for requestValidation api
 ```
    node testBlockChainController.js reqVa
 ```
